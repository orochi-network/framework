...
export class Connector {
  ...
  public static connect(dbConfig: Knex.Config, instanceName: string = '__default__'): Knex {
  ...
  public static connectByUrl(inputURL: string, instanceName: string = '__default__'): Knex {
